...
embeddinglayer = keras.layers.Embedding(vocab_size, 100, weights=[embedding_matrix], input_length=len(padded_docs[0]), mask_zero=True, trainable=False)
...
model.fit(padded_docs,y_data, batch_size=5000, epochs=1, verbose=1, callbacks=early_stop)
